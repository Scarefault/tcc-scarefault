...
namespace Tester
{
  ...
  class TesterAnalizer
  {
    ...
    private:
      ...
      std::vector<std::string> generate_args( int, Collector::Method );
      std::vector<std::string> generate_ints( int, Collector::Method );
      std::vector<std::string> generate_strings( int, Collector::Method );
  };
}
